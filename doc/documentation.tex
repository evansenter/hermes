...
\begin{itemize}
  ...
  \item I'm getting a compile-time error indicating undefined symbols for \ttt{\_get\_iindx}, \\ \ttt{\_maximumMatchingConstraint} or something similar.
  \begin{description}
