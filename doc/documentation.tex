...
\begin{description}
  ...
  \fixedWidthInList{\textnormal{GNU99 compiler:}}{}{}{ \\
    Most C compilers should support the {\tt -std=gnu99} flag, which is required for GNU library extensions, particularly {\tt unistd.h}}
  \fixedWidthInList{\textnormal{C++11 compiler:}}{}{}{ \\
    C++11 support (included in {\tt g++} $\geq$ 4.7) is necessary for proper struct initialization in \fft.}
  ...
  \fixedWidthInList{libRNA.a}{($\geq$ 2.0.7, tested through 2.1.7)}{http://www.tbi.univie.ac.at/RNA/}{ \\
    Various ViennaRNA functions and data structures are leveraged for homogenous energy model support, as well as {\tt fold\_par}, {\tt pf\_fold\_par}, and {\tt subopt\_par}. We additionally make use of ViennaRNA functions to compute the maximum base pair distance between two structures, required for bounding the polynomial size in \fft.}
\end{description}
