...
double estimate_equilibrium(const EIGENSYSTEM, const KLP_PARAMS, const POPULATION_PARAMS, int);
...
int* array_of_indices_to_output(const EIGENSYSTEM, const KLP_PARAMS, const POPULATION_PARAMS, double);
...
void print_square_matrix(char*, double*, int);
