...
void print_eigensystem(const EIGENSYSTEM eigensystem) {
  ...
  print_square_matrix("eigensystem.vectors", eigensystem.vectors, eigensystem.length);
  print_square_matrix("eigensystem.inverse_vectors", eigensystem.inverse_vectors, eigensystem.length);
}
